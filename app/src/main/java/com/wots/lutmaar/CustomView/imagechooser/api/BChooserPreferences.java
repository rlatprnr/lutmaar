...
public class BChooserPreferences {
    ...
    private final static String SUB_FOLDER_NAME = "sub_folder_name";
    ...
    public String getFolderName(){
        return preferences.getString(FOLDER_NAME, "Lutmaar");
    }

    public void setSubFolderName(String subFolderName){
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString(SUB_FOLDER_NAME, subFolderName);
        editor.commit();
    }

    public String getSubFolderName(){
        return preferences.getString(SUB_FOLDER_NAME, "Upload");
    }
